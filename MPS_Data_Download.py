...
password = 'ecet2023'
device_id = '29116760-4a45-11ef-92e8-77982ca011ca'
...
def get_device_data(jwt_token):
    url = f'{thingsboard_url}/api/plugins/telemetry/DEVICE/{device_id}/values/timeseries?keys=temperature,pressure,Methane_gas_concentration&startTs={start_ts}&endTs={end_ts}&limit=10000&interval=5000'#&interval=5000&limit=1000&agg=AVG'
...
def save_to_csv(data):
    ...
    file_name = f"MPS_data_{timestamp_str}.csv"
